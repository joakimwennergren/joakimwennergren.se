  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <Grid container spacing={0}>
        <Grid size={2} sx={{ textAlign: 'center', padding: 4, borderBottom: '1px solid #ccc', borderRight: '1px solid #ccc', display: 'flex', alignItems: 'center', backgroundColor: '#f0f0f0' }}>
        </Grid>
        <Grid size={2.5} sx={{
        ...
        <Grid size={'grow'} sx={{ textAlign: 'center', padding: 4, borderBottom: '1px solid #ccc', borderRight: '1px solid #ccc', height: 100, }}>
          <Box></Box>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={0}>
        ...
        <Grid size={2.5} sx={{ padding: 4, borderBottom: '1px solid #ccc', borderRight: '1px solid #ccc', display: 'flex', alignItems: 'center', }}>
          <Typography variant='h1' sx={{ fontWeight: "bold", color: "#444" }}>Joakim</Typography>
        </Grid>
        <Grid size={4} sx={{ padding: 4, borderBottom: '1px solid #ccc', borderRight: '1px solid #ccc', display: 'flex', alignItems: 'center', }}>
          <Typography variant='h1' sx={{ fontWeight: "bold", color: "#444", }}>Wennergren</Typography>
        </Grid>
        <Grid size={3.5} spacing={10} sx={{ textAlign: 'center', padding: 2, borderBottom: '1px solid #ccc', borderRight: '1px solid #ccc', backgroundColor: '#f0f0f0' }}>
      ...
      <Grid container spacing={0}>
        ...
        <Grid size={3} sx={{ fontSize: 14, textAlign: 'center', padding: 4, borderBottom: '1px solid #ccc', borderRight: '1px solid #ccc', }}>
